...
### Dự án nổi bật (Pinned projects)
- **[BKonsole](https://github.com/thuanmazda/BKonsole)** – Máy chơi game cầm tay DIY sử dụng màn LCD 1602 và ma trận LED. (Thiết kế mạch cấp nguồn 5V, lập trình hiển thị LCD/LED)  
- **[IoT Smart Pillbox](https://github.com/thuanmazda/Smart-Pillbox)** – Hộp thuốc thông minh tự động (ESP32, cảm biến) với kết nối Wi-Fi để lập lịch phát thuốc.  
- **[WiFi-802.11-Simulator](https://github.com/thuanmazda/WiFi-802.11-Simulator)** – Mô phỏng hiệu năng mạng không dây chuẩn 802.11a/b/g bằng Cisco Packet Tracer, so sánh lý thuyết và thực tế.  

### Kỹ năng (Skills)
- **Lập trình & nhúng:** C/C++, Verilog, Arduino, ESP32, FreeRTOS  
- **Thiết kế phần cứng:** Altium Designer, OrCAD, Proteus, LTSpice, thiết kế và gia công PCB  
- **Mạng & IoT:** Cấu hình mạng (802.11), FreePBX (telephony), MQTT/đám mây, lập trình LaTeX, MATLAB  
...
|--------------------------------------|:----:|:--------------:|--------------------------------------------------------------------------------------------|--------------------------------------------------|
| [BKonsole](https://github.com/phandienxauxa/BKonsole)              | 0    | C/C++         | Máy chơi game cầm tay tự chế (LCD 1602, LED ma trận)                                      | Thiết kế nguồn 5V và giao tiếp LCD/LED.          |
